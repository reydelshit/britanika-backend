...
switch ($method) {
    case "GET":
        ...
        if (isset($_GET['user_id'])) {
            ...
            $sql = "SELECT cart.cart_id, products.product_id, products.product_price, products.product_image , products.product_name, cart.qty FROM 
            ((cart LEFT JOIN products ON cart.product_id = products.product_id) 
    ...
    case "POST":
        ...
        $sql = "INSERT INTO cart (cart_id, product_id, user_id, qty, created_at) VALUES (NULL,  :product_id, :user_id, :qty, :created_at)";
        $stmt = $conn->prepare($sql);
